...
public class InfoPart4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_part_04);
    ...
    //    gifImageView = (GifImageView)findViewById(R.id.validGIF);
...
//        }, 2100);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (AppConstants.checkInternetConnection(InfoPart4Activity.this)) {
                    showFullScreenAd();
                } else {
                    showNextScreen();
                }
//                Intent intent= new Intent(InfoPart4Activity.this, MainActivity.class);
...
//                finish();
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(InfoPart4Activity.this, InfoPart3Activity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
                finish();
            }
