...
public class InfoPart1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent= new Intent(InfoPart1Activity.this, InfoPart2Activity.class);
        ...
        if (!AppConstants.checkInternetConnection(InfoPart1Activity.this)) {
