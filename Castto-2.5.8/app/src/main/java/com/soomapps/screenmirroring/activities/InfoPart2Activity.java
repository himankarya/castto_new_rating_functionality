...
public class InfoPart2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_part_02);
        AppCompatDelegate.setCompatVectorFromResourcesEnabled(true);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (AppConstants.checkInternetConnection(InfoPart2Activity.this)) {
                    showAdd();
                } else {
                    showInfoScreen();
                }
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(InfoPart2Activity.this, InfoPart1Activity.class);
    ...
    private void showInfoScreen() {
        Intent intent = new Intent(InfoPart2Activity.this, InfoPart3Activity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
        startActivity(intent);
        finish();
    }
